      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 xl:grid-cols-6 gap-2.5">
        {sorted.map((book, i) => (
          ...
          >
            ...
            <div className="p-2.5">
              <h3 className="text-xs font-normal text-[rgba(255,255,255,0.75)] text-center truncate leading-tight group-hover:text-gold-300 smooth">{book.title}</h3>
              <p className="text-xs text-[rgba(255,255,255,0.5)] text-center truncate mt-0.5">{book.author}</p>
