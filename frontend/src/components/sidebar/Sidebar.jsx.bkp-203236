...
import { Home, Library, BookText, Star, Download, FilePen, History, BookOpen } from 'lucide-react'
    ...
    <>
      ...
      `}>
        ...
        <div className="p-3 border-t border-border">
          <div className="rounded-lg bg-bg-card p-2.5 border border-border text-center">
            <span className="text-[10px] text-text-tertiary">
              <span className="text-gold-400 font-medium">100K+</span> títulos
            </span>
          </div>
        </div>
      </aside>
